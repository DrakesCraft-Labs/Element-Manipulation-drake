...
public class RockAnalyzer extends RockAnalyzerGui implements RecipeDisplayItem {
    ...
    public List < ItemStack > getDisplayRecipes() {
        ...
        displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results"));
        displayRecipes.add(Analisis.HEMATITE);
        displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results"));
        displayRecipes.add(Analisis.MAGNETITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.MAGNESIOFERRITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.GOETHITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.HYDROGOETHITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.LIMONITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.SIDERITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.PYRITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.PYRROTITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.ILMENITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.FOOL_GOLD); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.CALAVERITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.BISMITE); displayRecipes.add(new CustomItemStack(Material.GREEN_STAINED_GLASS_PANE, "&aPossible results")); displayRecipes.add(Analisis.BISMUTHINITE);
